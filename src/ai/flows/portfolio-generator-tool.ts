...
- **Hero Section with Glitch Animation:**
  - The user's name and headline must appear with a high-tech "glitch" text effect, as if being decoded or materializing on a futuristic display. This must be a pure CSS animation.
